...
//        fragment.setArguments(args);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        coloc.addColocataire(maxime);

        coloc.addExpense(new Expense(quentin, new Colocataire[]{maxime, thomas}, 196));
        coloc.addExpense(new Expense(quentin, new Colocataire[]{thomas}, 10));
        coloc.addExpense(new Expense(quentin, new Colocataire[]{maxime}, 600));
        coloc.addExpense(new Expense(quentin, new Colocataire[]{maxime, thomas}, 54));
        ////////////////////////////////////////////////////////////////////
